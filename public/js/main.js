...
var _user$project$Main$renderCountry = F2(
	function (selected, country) {
		...
		return A2(
			...
			isSelected,
			_elm_lang$core$Basics$toString(country));
	});
...
var _user$project$Main$citiesIn = function (country) {
	return A2(
		_elm_lang$core$List$filter,
		function (_p5) {
			return A2(
...
var _user$project$Main$activeCities = function (_p6) {
	...
	switch (_p8.ctor) {
		case 'CitySelected':
			return _user$project$Main$citiesIn(_p8._0.country);
		case 'CountrySelected':
			return _user$project$Main$citiesIn(_p8._0);
		default:
			return _user$project$Main$cities;
	}
};
var _user$project$Main$activeCountries = A2(
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p11 = msg;
		if (_p11.ctor === 'SelectCountry') {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					selected: _user$project$Main$setCountry(_p11._0)
				});
		} else {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					selected: _user$project$Main$setCity(_p11._0)
				});
		}
	});
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							...
							_1: A2(
								_elm_lang$core$List$map,
								_user$project$Main$renderCountry(model.selected),
								_user$project$Main$activeCountries)
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SelectCity":["String"],"SelectCountry":["String"]}}},"aliases":{},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
