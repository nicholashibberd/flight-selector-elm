...
var _user$project$Main$renderCountry = F2(
	function (selected, country) {
		var isSelected = function () {
			...
			switch (_p4.ctor) {
				case 'CitySelected':
					return _elm_lang$core$Native_Utils.eq(country, _p4._0.country);
				case 'CountrySelected':
					return _elm_lang$core$Native_Utils.eq(country, _p4._0);
				default:
					return false;
			}
		}();
		return A2(_user$project$Main$renderOption, isSelected, country.name);
	});
var _user$project$Main$citiesIn = F2(
...
var _user$project$Main$countries = function (cities) {
	return A2(
...
var _user$project$Main$countryOptions = function (_p6) {
	var _p7 = _p6;
	return A2(
		_elm_lang$core$List$map,
		_user$project$Main$renderCountry(_p7.selected),
		_user$project$Main$countries(_user$project$Main$cities));
};
var _user$project$Main$activeCities = function (_p8) {
	var _p9 = _p8;
	var _p10 = _p9.selected;
	switch (_p10.ctor) {
		case 'CitySelected':
			return A2(_user$project$Main$citiesIn, _user$project$Main$cities, _p10._0.country);
		case 'CountrySelected':
			return A2(_user$project$Main$citiesIn, _user$project$Main$cities, _p10._0);
		default:
			return _user$project$Main$cities;
	}
};
var _user$project$Main$cityOptions = function (model) {
	return A2(
		_elm_lang$core$List$map,
		_user$project$Main$renderCity(model.selected),
		_user$project$Main$activeCities(model));
};
var _user$project$Main$Country = function (a) {
	return {name: a};
};
...
var _user$project$Main$NothingSelected = {ctor: 'NothingSelected'};
var _user$project$Main$model = {selected: _user$project$Main$NothingSelected};
...
var _user$project$Main$setCountry = function (string) {
	return A2(
		...
		_user$project$Main$NothingSelected,
		A2(
			_elm_lang$core$Maybe$map,
...
var _user$project$Main$SelectCountry = function (a) {
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$select,
				{
					...
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SelectCountry),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_1: _user$project$Main$countryOptions(model)
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$select,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Events$onInput(_user$project$Main$SelectCity),
							_1: {ctor: '[]'}
						}
					},
					{
						...
						_1: _user$project$Main$cityOptions(model)
					}),
				_1: {
					ctor: '::',
					_0: _user$project$Main$renderPrice(model),
					_1: {ctor: '[]'}
				}
			}
		});
